...
<body>
    ...
    <div id="list">
        ...
        %>
                    <a href="javascript:void(0);" onclick="loadDetails(<%= id %>)"><%= name %></a>
        <%
                }
            } catch (Exception e) {
    ...
    <%
        ...
        if (idParam != null) {
            ...
            try {
                ...
                // 查询指定 ID 的土木遗产信息
                String sql = "SELECT 名称, 県名, 所在地, 概要, 建設年, 受賞年 FROM message WHERE id = " + id;
                rs = stmt.executeQuery(sql);
                ...
                if (rs.next()) {
                    ...
                    response.getWriter().write("{\"name\":\"" + name + "\",\"prefecture\":\"" + prefecture + "\",\"location\":\"" + location + "\",\"description\":\"" + description + "\",\"buildYear\":\"" + buildYear + "\",\"awardYear\":\"" + awardYear + "\",\"latitude\":\"35.6895\",\"longitude\":\"139.6917\"}");
                }
            } catch (Exception e) {
